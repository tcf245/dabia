...
def get_next_card(
    ...
    if not next_card_db:
        ...
        return schemas.NextCardResponse(
            card=None,
            session_progress=schemas.SessionProgress(completed_today=0, goal_today=50)
        )
    ...
    # Dummy progress for MVP
    progress = schemas.SessionProgress(completed_today=1, goal_today=50)
